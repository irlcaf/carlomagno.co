...
kind: 'Note'
summary: 'Notes from building a secure email pipeline with AWS messaging, Lambda, DynamoDB, a proprietary blockchain layer, and ML-based threat classification.'
---
